...
public class RdoGroupFragment extends Fragment {
    String[] answersArray;
    ...
    public void onResume() {
        ...
        this.radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            /* class com.sthoksdevs.sthoks.fragments.RdoGroupFragment.C06571 */

            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                RdoGroupFragment.this.rdoBtn = (RadioButton) radioGroup.findViewById(radioGroup.getCheckedRadioButtonId());
                if (RdoGroupFragment.this.rdoBtn.isChecked()) {
                    RdoGroupFragment.this.mCallback.updateAnswer(RdoGroupFragment.this.rdoBtn.getText().toString());
                }
            }
        });
    }
